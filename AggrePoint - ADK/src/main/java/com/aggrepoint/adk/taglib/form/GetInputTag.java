...
public class GetInputTag extends BodyTagSupport implements IAdkConst {
	...
	public int doStartTag() throws JspException {
		...
		if (strValidate != null && !strValidate.trim().equals(""))
			input.addValidator(null, strValidate, "", "", "", null);
