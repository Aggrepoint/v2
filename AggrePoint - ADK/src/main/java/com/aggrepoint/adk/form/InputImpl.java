...
public abstract class InputImpl implements Input {
	...
	ValidateResultType validate(IModuleRequest req, Object val) {
		// 校验
		if (vecValidators != null)
	...
	public ValidateResultType populate(IModuleRequest req, String[] value) {
		...
		try {
			...
			form.recordChange(new ChangeUpdateValidateResult(strName,
					getError()));
		}
	}
	...
	static InputImpl getInstance(FormImpl form, String type, Winlet winlet,
			String name) {
		if (type == null)
			return null;
